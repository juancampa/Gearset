...
namespace DebugConsole.Components
{
    ...
    public class XnaConsoleComponent : DebugComponent
    {
        enum ConsoleState
        {
            Closed,
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (State == ConsoleState.Closed)
            {
                if (IsKeyPressed(Keys.OemTilde)) //this opens the console
                {
                    ...
                    StateStartTime = now;
                    XdtkResources.Console.InputEnabled = true;
                    this.Visible = true;
                }
                else
                {
            ...
            if (State == ConsoleState.Open)
            {
                ...
                if (IsKeyPressed(Keys.OemTilde))
                {
                    ...
                    StateStartTime = now;
                    XdtkResources.Console.InputEnabled = false;
                    return;
                }
                #endregion
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            consoleXSize = this.Game.Window.ClientBounds.Right - this.Game.Window.ClientBounds.Left - 320;
            consoleYSize = this.font.LineSpacing * LinesDisplayed + 20;

            //set the offsets 
            int consoleXOffset = 300;
