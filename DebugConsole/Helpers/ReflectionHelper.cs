...
namespace Gearset
{
    ...
    public static class ReflectionExtensionMethods
    {
        ...
        {
            if (skipPrivate)
                return (FieldInfo[])t.GetFields(BindingFlags.Default | BindingFlags.Public | BindingFlags.Instance);
            else
                return (FieldInfo[])t.GetFields(BindingFlags.Default | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        }
        ...
        {
            if (skipPrivate)
                return (PropertyInfo[])t.GetProperties(BindingFlags.Default | BindingFlags.Public | BindingFlags.Instance);
            else
                return (PropertyInfo[])t.GetProperties(BindingFlags.Default | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
        }
        ...
        {
            return (MethodInfo[])t.GetMethods(BindingFlags.Default | BindingFlags.Public | BindingFlags.Instance);
        }
        ...
        {
            return (MethodInfo[])t.GetMethods(BindingFlags.Default | BindingFlags.Public | BindingFlags.Static);
        } 
        #endregion
    }
}
